...
TARGETS_TAGS := draft-zhang-alto-multipart-00 draft-zhang-alto-multipart-01 draft-zhang-alto-multipart-02 draft-zhang-alto-multipart-03
...
draft-zhang-alto-multipart-04.md: draft-zhang-alto-multipart.md
	sed -e 's/draft-zhang-alto-multipart-latest/draft-zhang-alto-multipart-04/g' $< >$@
diff-draft-zhang-alto-multipart.html: draft-zhang-alto-multipart-03.txt draft-zhang-alto-multipart-04.txt
	-$(rfcdiff) --html --stdout $^ > $@
